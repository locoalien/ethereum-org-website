...
export const query = graphql`
  query {
    ...
    dapps: file(relativePath: { eq: "azure.png" }) {
      ...actionCardImage
    }
    wallets: file(relativePath: { eq: "googlecloud.png" }) {
      ...actionCardImage
    }
    eth: file(relativePath: { eq: "aws.png" }) {
      ...actionCardImage
    }
    dao: file(relativePath: { eq: "use-cases/iot.png" }) {
      ...useCaseImage
    }
    defi: file(relativePath: { eq: "ai.png" }) {
      ...useCaseImage
    }
